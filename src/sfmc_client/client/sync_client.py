...
class SyncClient(BaseClient):
    def __init__(
        ...
        """
        Synchronous API client for Salesforce Marketing Cloud.

        This client uses synchronous transport and auth layers and provides
        ...
        self.http_client = http_client or SyncHTTPClient(self.config)
        self.auth_manager = auth_manager or AuthManager(self.config, self.http_client)
    ...
    def make_rest_request(
        ...
        """
        Make an authenticated sync REST request.
        ...
        return self.http_client.rest_request(method, endpoint, data)
    ...
    def make_soap_request(
        ...
        """
        self.auth_manager.ensure_authenticated()
        return self.http_client.soap_request(action, body)
